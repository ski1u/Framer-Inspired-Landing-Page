...
const OAuthButton = ({provider, redirectRoute, children, logo, logoClassname, ...props} : {
  ...
  return (
    <Button  onClick={async () => await signinUsingOAuth(provider, redirectRoute)} variant="outline" className='w-full flex items-center justify-center space-x-2' {...props}>
        <div>
